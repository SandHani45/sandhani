        ...
        <header>
            ...
            <div class="global-menu">
                <div class="global-menu__wrap" role="menu">
                    <a class="global-menu__item global-menu__item--transition" data-num-id="0" href="#home">Home</a>
                    <a class="global-menu__item global-menu__item--transition" data-num-id="1" href="#profile">Profile</a>
                    <a class="global-menu__item global-menu__item--transition" data-num-id="2" href="#resume">Resume</a>
                    <a class="global-menu__item global-menu__item--transition" data-num-id="3" href="#services">Services</a>
                    <a class="global-menu__item global-menu__item--transition" data-num-id="4" href="#portfolio">Portfolio</a>
                    <a class="global-menu__item global-menu__item--transition" data-num-id="5" href="#contact">Contact</a>
                </div>
            </div>
        </header>
                        ...
                        <div class="sub-section">                            
                            <div class="row">
								<div class="col-xs-12 col-md-4">
                                    <img src="img/sandhani.jpg" class="profile-image" alt="Profile">
                                </div>
                                <div class="col-xs-12 col-md-8">
									<div class="col-xs-12">									
										<h1>Sandhani Shaik</h1>
										<p><strong>Web And UI Developer</strong></p>
									...
									<div class="col-xs-12 col-md-6">									
                                    	<ul class="profile-data">											
											<li>
												...
												<div class="profile-intro"><b>Phone: </b>7013133051	</div>
											</li>
											<li>
												<div class="profile-icon"><i class="fa fa-envelope-open"></i></div>
												<div class="profile-intro"><b>Email: </b>sandhani.sk45@gmail.com</div>
											</li>
											<li>
												<div class="profile-icon"><i class="fa fa-facebook-square"></i></div>
												<div class="profile-intro"><b><a href="#">facebook.com/sandhanishaik45</a></b></div>
											</li>
											<li>
												<div class="profile-icon"><i class="fa fa-linkedin-square"></i></div>
												<div class="profile-intro"><b><a href="#">linkedin.com/in/sandhani-shaik-8bb76aa4/</a></b></div>
											</li>
										</ul>
									</div>
									<div class="col-xs-12 col-md-6">									
                                    	<ul class="profile-data">
											<li>
												...
												<div class="profile-intro"><b>Birthday: </b>July 02, 1994</div>
											</li>
											<li>
												<div class="profile-icon"><i class="fa fa-home"></i></div>
												<div class="profile-intro"><b>Address: </b>Btm 2nd stage ,35th main 5th cross,Banguloru/div>
											</li>
											<li>
									...
									<div class="col-xs-12 col-md-6">
										<a class="cv-btn" href="mailto:sandhani.sk45@gmail.com"><i class="fa fa-handshake-o"></i> Hire Me Now</a>										
									</div>
                                </div>                                
                            </div>
						</div>											
									...
									<div class="row">
										<div class="col-md-4 col-sm-6 col-xs-12">
											<div class="item">
												...
												<span class="item-title">Dance</span>                                                                                        
											</div>
										</div>
										<div class="col-md-4 col-sm-6 col-xs-12">
											<div class="item">
										...
										<div class="col-md-4 col-sm-6 col-xs-12">
											<div class="item">
												...
												<span class="item-title">Badminton</span>
											</div>
										</div>	
									</div>
								</div>
							 ...
							 <div class="row">
								<div class="col-md-4 col-sm-6">
									<div class="serviceBox">
										...
										<h3 class="title">UI Developement</h3>
										<p class="description">
								...
								<div class="col-md-4 col-sm-6">
									<div class="serviceBox">
										...
										<h3 class="title">Backend API'S </h3>
								...
								<div class="col-md-4 col-sm-6">
									<div class="serviceBox">
										...
										<h3 class="title">Mobile App's Developement</h3>
										<p class="description">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
										</p>
									</div>
								</div>
							...
							<div class="row">
								<div id="portfolio-grid" class="portfolio-grid portfolio-hover-w">
									...
									<div class="portfolio-item tall app">
										<a class="popup-text" href="#text-modal" title="Lorem Ipsum languages">
										...
										<div id="text-modal" class="mfp-hide white-popup-block">
											<h3>Lorem Ipsum languages</h3>
											...
											<p class="last-child">- by Alex Smith</p>
										</div>
									</div>
						 ...
						 <div class="sub-section">
							...
							<div class="contact-info text-center">
								<div class="col-xs-12 col-sm-4 contact-box">												
									...
									<span class="contact-texts">+91-7013133051</span>													
								</div>
								<div class="col-xs-12 col-sm-4 contact-box">												
									<div class="contact-icon"><i class="fa fa-envelope-square"></i></div>
									<p class="contact-title">Email</p>
									<span class="contact-texts"><a href="#">sandhani.sk45@gmail.com</a></span>
								</div>
								<div class="col-xs-12 col-sm-4 contact-box">												
									<div class="contact-icon"><i class="fa fa-address-book"></i></div>
									<p class="contact-title">Address</p>
									<span class="contact-texts">#103,BTM 2nd Stage 29th Main 5th Cross ,Bangulure</span>
								</div>
							</div>
							</div>
						 </div>						 
						...
						<div class="sub-section">  
							<div class="row">						 
								<div class="col-xs-12 text-center">												
									&copy; All rights reserved. | Designed by Sandhani Shaik
								</div>
							</div>
						 </div>							 
                    </div>
