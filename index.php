                ...
                <section class="content" id="about">
                    <div class="block-content">
                        ...
                        <div class="info-list row">
                            ...
                            <div class="col-sm-6"><span>Address : </span> Btm 2nd stage ,35th main, 5th cross, Bangalore 560076</div>
                            <div class="col-sm-6"><span>Email : </span> sandhani.sk45@gmail.com</div>
                            <div class="col-sm-6"><span>Phone : </span>+91 7013133051</div>
                    ...
                    <div class="block-content">
                        ...
                        <label class="progress-bar-label">HTML&amp;CSS - <span>2 years experience</span></label>
                        <div class="progress">
                            <div style="width: 95%;" class="progress-bar" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">
                                <span>95%</span>
                            </div>
                        </div>
                        <label class="progress-bar-label">Javascript - <span>2 years experience</span></label>
                        <div class="progress">
                            <div style="width: 75%;" class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                                <span>75%</span>
                            </div>
                        </div>
                        <label class="progress-bar-label">React/Redux - <span>1.5 years experience</span></label>
                        <div class="progress">
                            <div style="width: 50%;" class="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                                <span>50%</span>
                            </div>
                        </div>
                        <label class="progress-bar-label">Php &amp;Laravel  - <span>2 years experience</span></label>
                        <div class="progress">
                            <div style="width: 75%;" class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                                <span>75%</span>
                            </div>
                        </div>
                        <label class="progress-bar-label">Node js &amp;Express js  - <span>6 Months experience</span></label>
                        <div class="progress">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item artwork">
                                        <a class="open-project" href="project-1.html">
                                            <div class="portfolio-column">
                                                ...
                                                <img src="images/portfolio/krackerz.PNG" alt="">
                                            </div>
                                        </a>
                                    </div>
                                    <!-- WORK 1 END -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item artwork">
                                        <a class="open-project" href="project-2.html">
                                            <div class="portfolio-column">
                                                ...
                                                <img src="images/portfolio/prathigna.PNG" alt="">
                                            </div>
                                        </a>
                                    </div>
                                    <!-- WORK 2 END -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item webdesign">
                                        <a class="open-project" href="project-3.html">
                                            <div class="portfolio-column">
                                                ...
                                                <img src="images/portfolio/svasth.PNG" alt="svasth">
                                            </div>
                                        </a>
                                    </div>
                                    <!-- WORK 3 END -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item artwork">
                                        <a class="open-project" href="project-4.html">
                                            <div class="portfolio-column">
                                                ...
                                                <img src="images/portfolio/applaunch.PNG" alt="">
                                            </div>
                                        </a>
                                    </div>
                                    <!-- WORK 4 END -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item artwork">
                                        <a class="open-project" href="project-5.html">
                                            <div class="portfolio-column">
                                                ...
                                                <img src="images/portfolio/innovision.PNG" alt="">
                                            </div>
                                        </a>
                                    </div>
                                    <!-- WORK 5 END -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item artwork">
                                        <a class="open-project" href="project-6.html">
                                            <div class="portfolio-column">
                                                ...
                                                <img src="images/portfolio/oonsport.PNG" alt="">
                                            </div>
                                        </a>
                                    </div>
                                    <!-- WORK 6 END -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item webdesign">
                                        <a class="open-project" href="project-1.html">
                                            <div class="portfolio-column">
                                                ...
                                                <img src="images/portfolio/truckerunion.PNG" alt="">
                                            </div>
                                        </a>
                                    </div>
                                    <!-- WORK 7 END -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item webdesign">
                                        <a class="open-project" href="project-2.html">
                                            <div class="portfolio-column">
                                                ...
                                                <img src="images/portfolio/ibe-optics.PNG" alt="">
                                            </div>
                                        </a>
                                    </div>
                                    <!-- WORK 8 END -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item webdesign">
                                        <a class="open-project" href="project-1.html">
                                            <div class="portfolio-column">
                                                ...
                                                <img src="images/portfolio/whatup.PNG" alt="">
                                            </div>
                                        </a>
                                    </div>
                                    <!-- WORK 9 END -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 offset-md-1">
                                ...
                                <div class="contact-content">
                                    ...
                                    <div class="contact-details">
                                        <h5>Call Us</h5>
                                        <p> <a href="tel:+91-7013133051">+91-7013133051</a></p>
                                    </div>
                                </div>
                                <div class="contact-content">
                                    <div class="contact-icon">
